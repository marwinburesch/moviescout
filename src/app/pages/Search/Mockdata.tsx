export const mockTagGroupProps = [
  { children: 'Animation', count: '0' },
  { children: 'Action', count: '3', active: true },
...
const mockCard = {
  ...
  rating: 4.5,
  image:
    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTHILF70VeqhsH_fzgLs2X_5X_zP1Q6_tuEqLeo8p_vIsfeigYK4xqyvWI5pzYZZ2Hf2Bk&usqp=CAU',
  children:
